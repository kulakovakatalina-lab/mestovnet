...
# (часть из них — организаторы/фестивали, а не физическая площадка).
# Обновлено 2026-07-05 при публикации — на момент мержа в main список вырос
# с 6 до 14 из-за новых событий от парсера, добавленных независимо от этой
# ветки. Разобрать эти площадки отдельно — venues.json vs. новые записи.
KNOWN_UNREGISTERED_VENUES = {
    "Comedy Republic",
    "БЦ Царская Пристань",
    "Зеленый Кордон (яблоневый сад, Бельбекская долина)",
    "Крым Event",
    "Крымские Дела",
    "Скажите Джаз",
    "Афиша PayBerry",
    "Винзавод Массандра",
    "Отель «Ялта-Интурист», концерт-холл «Хрустальный»",
    "Пещера «Мраморная»",
    "Пляж «Ковёр», 7-й сектор Массандровского пляжа",
    "Поляна Вкусов, Ярмарочное Поле, Пания Парк",
    "Севастополь Джаз",
    "пляж Van Gogh",
}
